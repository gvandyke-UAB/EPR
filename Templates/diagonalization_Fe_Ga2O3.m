...
% Sixfold
T2 = (3*2213)*(S_zz - (1/3)*s_sq); % b20/cm-1 = 0.2213 (cm-1*3 *10^4 in MHz) 
T3 = (1/3)*(3*2091)*(S_xx-S_yy); % b22/cm-1 = 0.2091 Bushcher and lehmann
...
g = 2.0043;
theta = 90*pi/180; %90 is Bperp.b,theta= 0 is B //b
u0 = 13.996;% bohr magneton-MHz/mT
 
for i = 1:length(B0)
   
    T1 = u0*g*B0(i)*(cos(theta)*S_z+0.4115*sin(theta)*S_x-0.9112*sin(theta)*S_y);% sixfold
